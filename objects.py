...
class MovingObject:
    def __init__(self, name, start_x, start_y, vel_x, vel_y, turn_rate_deg, radius):
        self.name = name
        self.turn_rate_deg = turn_rate_deg
        self.radius = radius

        self.location_arr = np.array([start_x, start_y])
...
class PursuitObject(MovingObject):
    ...
    def _anglebetweenarr(self, arr1, arr2, degrees=True):
